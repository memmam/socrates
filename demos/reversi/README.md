# reversi — Othello on Int bitboards, in Fable
...
About 600 lines of Fable in four files (a fifth of that the pinned
game transcript):
...
```sh
./target/release/fable demos/reversi/main.fable   # play the game (instant)
./target/release/fable test demos/reversi         # golden tests (all four files)
```
